...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2024 at 08:27 AM
...
(70, 60, 'tetsinfsef', 'qerwqedfw', 220.00, '65ef54eb2c8c6.png'),
(72, 62, 'testing', 'test of the restaurant panel', 230.00, '65f194870fa6a.png'),
(73, 64, 'test', 'just for testing', 234.00, '65fc6e64618db.jpg'),
(74, 64, 'Gujarati thali', 'eoejfepjf', 200.00, '65fc6e9e5541b.jpg');
...
INSERT INTO `report` (`rp_id`, `r_name`, `r_number`, `r_data`) VALUES
(51, 'kashyap shah', 2147483647, 'Aerfeafeaf'),
(52, 'het shah', 2147483647, '\r\n[aekogrwog;ogwkoarw\"w;o'),
(53, 'rushabh', 2147483647, ':Lslm;msk');
...
(54, 11, 'Tipsy Burgers', 'tipsyburgers@gmail.com', 'lipsy23', '1212121212', 'www.tipsyburgers.com', '11am', '8pm', 'mon-sat', 'Alkapuri, near Railway Station, Vadadora, Gujarat.', '62710255ce1e8.jpg', '2024-03-11 07:13:49'),
...
(60, 13, 'testing ', 'testings@gmail.com', '07878787878', '12345678', 'awdd', '10am', '12pm', '24hr-x7', 'parul university waghodia road', '65eeb235206fa.png', '2024-03-11 07:26:45'),
(61, 11, 'hello', 'hello@gmail.com', '3636363636', 'hello123', 'dfse', '9am', '11pm', 'mon-thu', 'lohlubilguggo', '65eecc92634d2.png', '2024-03-11 09:19:14'),
(62, 13, 'kashyap', 'kashyap@gmail.com', 'testing@123', '2323232323', 'awdad', '10am', '11pm', 'mon-fri', 'sdfsdfsefsefsefes', '65ef369785a1c.png', '2024-03-11 16:51:35'),
(63, 13, 'roasting Chicken ', 'chicken@gmail.com', '25d55ad283aa400af464c76d713c07ad', '9292929292', 'aweda', '10am', '11pm', '24hr-x7', 'parul university waghodia road', '65f33e4844056.jpg', '2024-03-14 18:13:28'),
(64, 17, 'TGB', 'TGB@gmail.com', 'hetshah23', '7878787878', ';eJOffoiwhgoriprj', '6am', '8pm', '24hr-x7', 'Surat Gujarat', '65fc6e31bee56.jpg', '2024-04-09 05:53:58'),
(65, 17, 'TGBs', 'TGB@gmail.com', '7f38636ae2cb12119e9e5420e2f12825', '7878787878', ';eJOffoiwhgoriprj', '7am', '10pm', 'mon-fri', '86-110 Orchard St.', '65fc6ef399985.png', '2024-03-21 17:31:31'),
(66, 15, 'testing', 'kashyapshah238@gmail.com', '7f38636ae2cb12119e9e5420e2f12825', '02222222222', ';eJOffoiwhgoriprj', '--Select your Hours--', '--Select your Hours--', '--Select your Days--', '  eferf  ', '65fc8aed90cfd.jpg', '2024-03-21 19:30:53');
...
(17, 'Gujarati thali', '2024-03-21 17:25:36');
...
(37, 'yashshah', 'shah', 'yash', 'yashrana1974@gmail.com', '08989898989', '57f79611063044536dabfa1d452348db', 'Arth consultancy waghodiya road', 1, '2024-03-10 05:48:00');
...
INSERT INTO `users_orders` (`o_id`, `u_id`, `d_id`, `rs_id`, `title`, `quantity`, `price`, `instruction`, `status`, `date`) VALUES
(247, 34, 29, 55, 'BBQ Chicken Pizza', 1, 375.00, '', 'dispatch', '2024-03-31 06:28:15'),
(248, 34, 29, 54, 'BBQ Chicken Pizza', 1, 375.00, 'srsdfzdertddertdzdzertg', 'rejected', '2024-03-31 06:37:47'),
(249, 34, 19, 54, 'Veg Cheese Burger', 1, 95.00, 'srsdfzdertddertdzdzertg', 'dispatch', '2024-03-31 06:35:05'),
(250, 35, 74, 64, 'Gujarati thali', 1, 200.00, '', 'delivered', '2024-04-09 05:56:32'),
(251, 35, 19, 54, 'Veg Cheese Burger', 1, 95.00, 'gjgjghjfhjf', 'dispatch', '2024-04-09 06:01:29');
...
--
ALTER TABLE `dishes`
  MODIFY `d_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
...
--
ALTER TABLE `users_orders`
  MODIFY `o_id` int(222) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252;
COMMIT;
