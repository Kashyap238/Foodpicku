                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="bug.php">Contact Us <span class="sr-only"></span></a> </li>
							<?php
						if(empty($_SESSION["user_id"]))
							{
                                        ...
                                        <ul class=" list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" checked id="radioStacked1"  value="COD" type="radio" class="custom-control-input" required> <span class="custom-control-indicator"></span> <span class="custom-control-description"><img src="images/cash.png" alt="" width="25" />Take Away</span>
                                                   </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                <input name="mod"  value="paypal" type="radio" class="custom-control-input" required> <span class="custom-control-indicator"></span> <span class="custom-control-description"><img src="images/payment.png" alt="" width="25" />Home Delivery<br></span><span style="color:green;"> Paypal, Credit Card, Debit Card, Gpay</span> 
