        ...
        $error = '<div class="alert alert-danger alert-dismissible fade show">
                ...
                if($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {        
                    if($fsize >= 1000000) {
                        ...
                        $sql = "INSERT INTO restaurant(c_id,title,email, password ,phone,url,o_hr,c_hr,o_days,address,image) VALUES('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$password."','".$_POST['phone']."','".$_POST['url']."','".$_POST['o_hr']."','".$_POST['c_hr']."','".$_POST['o_days']."','".$_POST['address']."','".$fnew."')";
                        mysqli_query($db, $sql); 
                   ...
                   <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
						...
						<li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">All Orders</span></a>
                            ...
                            <li> <a class="has-arrow  " href="reviews.php" aria-expanded="false"><i class="fa fa-thumbs-up" aria-hidden="true"></i><span class="hide-menu">Reviews</span></a>
                            <ul aria-expanded="false" class="collapse">
